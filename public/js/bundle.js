...
var updatedDataForm = document.querySelector('.form-user-data');
var updatedPasswordForm = document.querySelector('.form-user-settings');
if (loginForm) {
...
if (updatedDataForm) {
  updatedDataForm.addEventListener('submit', function (e) {
    e.preventDefault();
...
if (updatedPasswordForm) {
  updatedPasswordForm.addEventListener('submit', /*#__PURE__*/function () {
